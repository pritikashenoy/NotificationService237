...
public class KafkaTopicConfig {
    ...
    {
        return TopicBuilder.name(topic1Name).partitions(topic1Partitions).replicas(1).build();
    }
    @Bean
    public NewTopic topic2()
    {
        return TopicBuilder.name(topic2Name).partitions(topic2Partitions).replicas(1).build();
    }
    @Bean
    public NewTopic topic3()
    {
        return TopicBuilder.name(topic3Name).partitions(topic1Partitions).replicas(1).build();
    }
}
